...
function AppLayout() { 
    return (
        <StyledAppLayout>
            <Header/>
            <Sidebar/>
            <Main> {/*//* placing Outlet around a main to allow easier styling. placing components with fragments will render with <main> styling*/}
            <Container> {/* //*Container is used to limit the width of the table content*/}
            <Outlet /> {/*//* renders nested routes (think {children for react-router})*/}
            </Container>
            </Main>
        </StyledAppLayout>
    )

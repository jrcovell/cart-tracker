...
if(pageCount <= 1) return null; // if there is only one page, do not show pagination

  return (
   <StyledPagination>
    <p>
      Showing <span>{(currentPage-1) * NUMBER_OF_ITEMS + 1}</span> to <span>{currentPage === pageCount ? count : currentPage * NUMBER_OF_ITEMS}</span>
